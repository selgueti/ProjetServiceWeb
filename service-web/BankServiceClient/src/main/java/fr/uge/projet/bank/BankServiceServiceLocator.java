...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements fr.uge.projet.bank.BankServiceService {
    ...
    private java.lang.String BankService_address = "http://localhost:8945/BankService/services/BankService";
    ...
    public fr.uge.projet.bank.BankService getBankService() throws javax.xml.rpc.ServiceException {
    ...
    public fr.uge.projet.bank.BankService getBankService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.projet.bank.BankServiceSoapBindingStub _stub = new fr.uge.projet.bank.BankServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.projet.bank.BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.projet.bank.BankServiceSoapBindingStub _stub = new fr.uge.projet.bank.BankServiceSoapBindingStub(new java.net.URL(BankService_address), this);
                _stub.setPortName(getBankServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://bank.projet.uge.fr", "BankServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://bank.projet.uge.fr", "BankService"));
        }
